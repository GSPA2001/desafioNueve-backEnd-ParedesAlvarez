...
try {
  ...
  const httpServer = app.listen(PORT, () => console.log(`Listening port ${PORT} ✅ MongoDB connected 🔌`));
  ...
  io.on('connection', async (socket) => {
    ...
    socket.on('message', async (messages) => {
      console.log(`The user ${messages.user} sent the following message: ${messages.message}`);
